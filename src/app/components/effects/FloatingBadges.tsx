...
const BADGES: FloatingBadge[] = [
  { label: "BigQuery", left: "6%", top: "14%", delay: "0s", duration: "7s", color: "#4285f4" },
  { label: "Dataflow", right: "8%", top: "20%", delay: "1.2s", duration: "8s", color: "#fbbc04" },
  { label: "Pub/Sub", left: "4%", top: "58%", delay: "0.6s", duration: "9s", color: "#34a853" },
  { label: "Composer", right: "5%", top: "52%", delay: "1.8s", duration: "7.5s", color: "#ea4335" },
  { label: "GCS", left: "12%", top: "78%", delay: "2.4s", duration: "8.5s", color: "#18c29c" },
  { label: "Beam", right: "14%", top: "72%", delay: "0.9s", duration: "6.5s", color: "#7cc7ff" },
];
