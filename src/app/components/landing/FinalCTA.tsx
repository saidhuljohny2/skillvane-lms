  ...
  return (
    <section className="relative overflow-hidden border-t border-white/[0.07] bg-[#060d17] py-16 sm:py-24">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal className="relative overflow-hidden rounded-[1.75rem] border border-[#3b82f6]/20 bg-[#0b1725] px-6 py-14 text-center shadow-[0_30px_80px_rgba(0,0,0,0.3)] sm:px-12 sm:py-16">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <button
              ...
              className="magnetic-button group mt-8 inline-flex items-center gap-2 rounded-xl bg-[#3b82f6] px-9 py-4 text-base font-black text-[#ffffff] shadow-xl shadow-[#3b82f6]/10 hover:bg-[#60a5fa]"
            >
              Browse All Courses
